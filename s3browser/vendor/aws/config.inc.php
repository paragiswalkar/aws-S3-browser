<?php
define('AWS_KEY', 'AKIAIVSMOFRPB77YORTQ');
define('AWS_SECRET_KEY', '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');
define('AWS_ACCOUNT_ID', '443392176537');
...
CFCredentials::set(array(
    ...
    'development' => array(
        'key' => 'AKIAIVSMOFRPB77YORTQ',
        'secret' => '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',
        'default_cache_config' => 'apc',
        'certificate_authority' => false
    ),
